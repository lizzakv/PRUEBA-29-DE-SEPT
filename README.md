...
<section class="webdesigntuts-workshop">
	<form action="" method="">		    
		...
		<input type="button" value="Parques Botanicos" onclick="window.print()">
		<input type="button" value="Aguas termales" onclick="window.print()">
		<input type="button" value="Marca lo nuestro" onclick="window.print()">
		<input type="button" value="Mas que turismo" onclick="window.print()">
		<input type="button" value="Diversidad" onclick="window.print()">
		<input type="button" value="Contactanos" onclick="window.print()">
		<input type="button" value="Informacion" onclick="window.print()">
